...
public class MTLServerReplica {

	public static void main(String[] args) {

		try {
			//@formatter:off
			final List<String> replicaList = new ArrayList<>(Arrays.asList(LocationConstants.MONTREAL_REPLICA_1,
														   				   LocationConstants.MONTREAL_REPLICA_2, 
														   				   LocationConstants.MONTREAL_REPLICA_3));
			//@formatter:on
			
			final ActivityLoggerService activityLogger = new ActivityLoggerService(FileConstants.SERVER_LOG_FILE_PATH + LocationConstants.MONTREAL + "/" + args[0].trim()+FileConstants.FILE_TYPE);
